...
export function DemoAnnotationToggle({ className }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex items-center gap-1.5 rounded-full border border-zinc-200 bg-white/90 px-2.5 py-1 text-[11px] font-medium text-zinc-600 shadow-sm backdrop-blur-sm transition-colors hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900/90 dark:text-zinc-400 dark:hover:bg-zinc-800",
        className,
      )}
